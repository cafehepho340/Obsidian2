...
do
    ...
    ThemeManager.BuiltInThemes = {
        ["CelinA"] = {
            1,
            { FontColor = "ffffff", MainColor = "14141c", AccentColor = "00c8ff", BackgroundColor = "0c0c12", OutlineColor = "232332" },
        },
        ["Default"] = {
            2,
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        for _, data in ipairs(colorPairs) do
            groupbox:AddLabel(data[1]):AddColorPicker(data[2], { Default = self.Library.Scheme[data[2]] })
        end

        groupbox:AddDropdown("FontFace", {
            Text = "Font Face",
            Default = "Code",
            Values = { "BuilderSans", "Code", "Fantasy", "Gotham", "GothamBold", "Jura", "Roboto", "RobotoMono", "SourceSans" },
        })

        groupbox:AddLabel("────────────────── Preset Themes ──────────────────")
        ...
        groupbox:AddButton("Reset default", function()
            ...
            if success then
                self.Library:Notify("Reset default theme to Default")
            else
